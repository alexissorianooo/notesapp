...
export default function Notes(props){
    ...
    return(
        <div className='bg-white w-72 min-h-72 my-2 sm:h-full sm:justify-self-center drop-shadow-sm hover:drop-shadow-lg flex flex-col'>
            ...
            <hr />
            <div className='h-3/5 p-4 text-lg'>
                {props.noteContent}
            </div>
